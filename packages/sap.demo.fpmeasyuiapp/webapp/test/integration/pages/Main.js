sap.ui.require([
  ...
  var sViewName = "sap.demo.fpmeasyuiapp.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of sap.demo.fpmeasyuiapp"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title sap.demo.fpmeasyuiapp"
            });
        }
      }
